...
public class NotificationsResourceIntTest {
    ...
    public void createNotifications() throws Exception {
        ...
        assertThat(testNotifications.getStartTime()).isEqualTo(DEFAULT_START_TIME);
        assertThat(testNotifications.getEndTime()).isEqualTo(DEFAULT_END_TIME);
        assertThat(testNotifications.getStartDate()).isEqualTo(DEFAULT_START_DATE);
        assertThat(testNotifications.getEndDate()).isEqualTo(DEFAULT_END_DATE);
    ...
    public void updateNotifications() throws Exception {
        ...
        assertThat(testNotifications.getStartTime()).isEqualTo(UPDATED_START_TIME);
        assertThat(testNotifications.getEndTime()).isEqualTo(UPDATED_END_TIME);
        assertThat(testNotifications.getStartDate()).isEqualTo(UPDATED_START_DATE);
        assertThat(testNotifications.getEndDate()).isEqualTo(UPDATED_END_DATE);
